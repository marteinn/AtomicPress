...
# Bump django version
sed -i.bak 's/^__version__.=.*/__version__ = '\'''$VERSION''\''/' $ROOTDIR/atomicpress/__init__.py
rm atomicpress/__init__.py.bak

# Bump django build
sed -i.bak 's/^__build__.=.*/__build__ = '$VERSION_BUILD'/' $ROOTDIR/atomicpress/__init__.py
rm atomicpress/__init__.py.bak
